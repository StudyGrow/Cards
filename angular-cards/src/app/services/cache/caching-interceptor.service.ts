...
import { decrementLoading, incrementLoading } from 'src/app/store/actions/StateActions';
import { WarnMessage } from 'src/app/models/Notification';

@Injectable()
export class CachingInterceptor implements HttpInterceptor {
  constructor(private cache: RequestCache, private store: Store, private notifs: NotificationsService) {}
