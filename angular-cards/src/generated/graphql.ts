...
export const CreateAccountDocument = gql`
  mutation CreateAccount($username: String!, $lastName: String, $firstName: String) {
    createAccount(data: { username: $username, lastName: $lastName, firstName: $firstName }) {
      _id
      username
      creationDate
      name
...
export class GetLectureByAbbreviationWithCardsAndVotesGQL extends Apollo.Query<
  GetLectureByAbbreviationWithCardsAndVotesQuery,
  GetLectureByAbbreviationWithCardsAndVotesQueryVariables
> {
...
export class GetLecturesWithCardsAndVotesGQL extends Apollo.Query<
  GetLecturesWithCardsAndVotesQuery,
  GetLecturesWithCardsAndVotesQueryVariables
> {
...
export const UpdateCardDocument = gql`
  mutation UpdateCard($_id: String!, $thema: String!, $content: String!, $tags: [String!]!, $latex: Float!) {
    updateCard(data: { _id: $_id, thema: $thema, content: $content, tags: $tags, latex: $latex }) {
      _id
      lectureAbbreviation
      thema
      content
...
export const UpdateUserDocument = gql`
  mutation UpdateUser($username: String, $firstName: String, $lastName: String) {
    updateUser(data: { username: $username, firstName: $firstName, lastName: $lastName }) {
      _id
      username
      creationDate
      name
